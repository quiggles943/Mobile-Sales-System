    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        syncFromDb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NetworkInfo wifiInfo = cManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI);                                //getting the wifi information
                NetworkInfo dataInfo = cManager.getNetworkInfo(ConnectivityManager.TYPE_DUMMY);                               //getting the mobile data information
